...
public class EmailUtility {
		...
		// Get the session object
				...
				Session session = Session.getInstance(props, new javax.mail.Authenticator() {
					protected PasswordAuthentication getPasswordAuthentication() {
						return new PasswordAuthentication("karkideependra58@gmail.com","ninjatown2");// change
																							// accordingly
					}
					});
					try {
	...
	public static void sendResetLink(String to,String token) {
		...
		try {
			...
			message.setFrom(new InternetAddress("anexus@gmail.com"));// change
																			// accordingly
...
//			message.setText("Click Here to Reset your password:" +"http://localhost:8080/swagger-ui.html#!/login-controller/resetPasswordUsingPOST/"+token);
			message.setText("Click Here to Reset your password:" +"http://anexus.com"+"Your token is:"+token);
